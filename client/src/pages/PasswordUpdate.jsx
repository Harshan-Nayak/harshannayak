...
const PasswordUpdate = () => {
  ...
  const form = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      newPassword: Yup.string()
        .min(8, "newPassword minimum 8 charcters")
        .required("newPassword is required"),
      ConfirmNewPassword: Yup.string()
        .oneOf([Yup.ref("newPassword")], "confirmNewPassword not match")
        .min(8, "ConfirmNewPassword minimum 8 charcters")
  ...
  const onUpdate = async (values) => {
    ...
    if (response) {
      ...
      toast.success("update passowrd success! Please re-login");
    }
  };

  return (
    <Box sx={{ ...uiConfigs.style.mainContent }}>
      <Container header="update passowrd">
